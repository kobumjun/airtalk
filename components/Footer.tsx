  ...
  return (
    <footer className="bg-slate-800 text-slate-200 mt-auto">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mt-4 pt-4 border-t border-slate-600 text-center text-xs text-slate-500">
          <Link href="/request" className="hover:text-slate-400">
            접수하기
          </Link>
          {' · '}
          <Link href="/reviews" className="hover:text-slate-400">
            고객후기
          </Link>
        </div>
      </div>
